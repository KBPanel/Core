<?php
    ...
    use KSeven\TelegramBot\Entities\Games\Game;
    use KSeven\TelegramBot\Entities\Payments\Invoice;
    use KSeven\TelegramBot\Entities\Payments\SuccessfulPayment;
    use KSeven\TelegramBot\Entities\TelegramPassport\PassportData;
