...
use PHPBotts\Core\Entities\CallbackQuery;
use PHPBotts\Core\Entities\ChatJoinRequest;
use PHPBotts\Core\Entities\ChatMemberUpdated;
use PHPBotts\Core\Entities\ChosenInlineResult;
use PHPBotts\Core\Entities\InlineQuery;
use PHPBotts\Core\Entities\Message;
use PHPBotts\Core\Entities\Payments\PreCheckoutQuery;
use PHPBotts\Core\Entities\Payments\ShippingQuery;
use PHPBotts\Core\Entities\Poll;
use PHPBotts\Core\Entities\PollAnswer;
