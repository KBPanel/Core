<?php
    ...
    use KSeven\TelegramBot\Entities\CallbackQuery;
    use KSeven\TelegramBot\Entities\ChatJoinRequest;
    use KSeven\TelegramBot\Entities\ChatMemberUpdated;
    use KSeven\TelegramBot\Entities\ChosenInlineResult;
    use KSeven\TelegramBot\Entities\InlineQuery;
    use KSeven\TelegramBot\Entities\Message;
    use KSeven\TelegramBot\Entities\Payments\PreCheckoutQuery;
    use KSeven\TelegramBot\Entities\Payments\ShippingQuery;
    use KSeven\TelegramBot\Entities\Poll;
    use KSeven\TelegramBot\Entities\PollAnswer;
